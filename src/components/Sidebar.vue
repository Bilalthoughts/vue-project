<template>
  <div class="w-25 pt-5 shadow drawerWrapper">
    <ul class="drawerLi row gy-5 container">
      ...
      <li class="d-flex justify-content-between align-items-center dropdown">
        <div>
          ...
          <span @click="async ()=>{ await $store.dispatch('allProducts'); console.log($store.state.allProductsArray,'allProductsArray')}">Sale</span>
        </div>
        <div>
      ...
      <li class="d-flex justify-content-between bg-primary px-3 py-1 rounded align-items-center">
